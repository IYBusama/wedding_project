 ...
 <aside class="w-full md:w-64 bg-white shadow-lg p-6 flex flex-col">
     <div class="text-2xl font-bold text-gray-800 mb-8">EventSys Admin</div>
     <nav>
         <ul class="space-y-2">
             <li>
                 <a href="#" class="flex items-center p-3 rounded-lg bg-gray-200 text-gray-800 font-semibold transition-colors duration-200">
                     Dashboard
                 </a>
             </li>
             <li>
